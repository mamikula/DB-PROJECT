    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                afeIndex = self.tree.openElements.port_list(formattingElement)
                furthestBlock = None
                ...
                bookmark = self.tree.activeFormattingElements.port_list(formattingElement)

                # Step 9
                lastNode = node = furthestBlock
                innerLoopCounter = 0

                index = self.tree.openElements.port_list(node)
                while innerLoopCounter < 3:
                    ...
                    if lastNode == furthestBlock:
                        bookmark = self.tree.activeFormattingElements.port_list(node) + 1
                    # Step 9.8
                    clone = node.cloneNode()
                    # Replace node with clone
                    self.tree.activeFormattingElements[
                        self.tree.activeFormattingElements.port_list(node)] = clone
                    self.tree.openElements[
                        self.tree.openElements.port_list(node)] = clone
                    node = clone
                    # Step 9.9
                ...
                self.tree.openElements.insert(
                    self.tree.openElements.port_list(furthestBlock) + 1, clone)
